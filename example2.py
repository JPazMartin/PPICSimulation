"""
    ...
    ionization chamber exposed to a 0.1415 Gy pulse of 2.5 us duration. This
    example shows how to include a custom pulse shape.
"""
...
inputParameters = [dpp, pulseDuration, alpha, voltage, temperature, pressure,
                   rHumidity, gap, n, Ndw * kQ, area, tStruct, dStruct]
